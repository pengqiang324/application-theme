...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".content-box{padding:24px;background:#fff}.content-box,.content-table-box{position:relative}.content-table-box.content-table-loading{opacity:.3}.content-box-min-height .el-dialog__wrapper{overflow:hidden}.content-box-min-height .el-dialog__body{max-height:390px;overflow-y:auto;box-sizing:border-box}.spin-box{position:absolute;top:50px;left:0;width:100%;height:calc(100% - 50px);max-height:400px;display:flex;align-items:center;justify-content:center}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d503511a-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./theme/components/Content.vue?vue&type=template&id=0be526f7&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-row',[_c('el-col',{class:['content-box', {'content-box-min-height': _vm.startMinHeight}],style:({'min-height': _vm.startMinHeight ? _vm.minHeight : ''}),attrs:{"span":24}},[_vm._t("tabs"),_vm._t("tool"),_c('div',{class:['content-table-box', { 'content-table-loading': _vm.loading }]},[_vm._t("default")],2),(_vm.loading)?_c('div',{staticClass:"spin-box"},[_c('Spin')],1):_vm._e()],2)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./theme/components/Content.vue?vue&type=template&id=0be526f7&
